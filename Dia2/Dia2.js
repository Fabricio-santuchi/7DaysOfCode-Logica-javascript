...
estudante.linguagem = prompt(
  "Qual linguagem de programação você está estudando?"
);

alert(
  `Olá ${estudante.nome}, você tem ${estudante.idade} anos e já está aprendendo ${estudante.linguagem}!`
);

const resposta = parseInt(
  prompt(
    `Você gosta de estudar ${estudante.linguagem}? Responda com o número 1 para SIM ou 2 para NÃO.`
  )
);
